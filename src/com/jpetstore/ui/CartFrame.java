...
import com.jpetstore.dao.OrderDao;
import com.jpetstore.dao.OrderDetailDao;
import com.jpetstore.dao.ProductDao;
import com.jpetstore.dao.mysql.OrderDaoImp;
import com.jpetstore.dao.mysql.OrderDetailDaoImp;
import com.jpetstore.dao.mysql.ProductDaoImp;
import com.jpetstore.domain.Order;
import com.jpetstore.domain.OrderDetail;
...
public class CartFrame extends MyFrame {
	...
	private JTable getTable() {
		...
		// 准备表中数据
		data = new Object[cart.size()][5];Set<String> keys = this.cart.keySet();
		int indx = 0;
